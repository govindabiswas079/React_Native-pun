...
const AccountScreen = () => {
    ...
    const data = [
        ...
        { id: 2, name: 'Privacy policy', navigation: () => Navigation.navigate('PrivacyScreen'), mainicon: <MaterialIcons size={22} name={'privacy-tip'} color={'#000000'} />, icon: <Feather size={25} name={'chevron-right'} color={'#000000'} /> },
        { id: 3, name: 'About Us', navigation: () => Navigation.navigate('AboutusScreen'), mainicon: <MaterialIcons size={22} name={'info'} color={'#000000'} />, icon: <Feather size={25} name={'chevron-right'} color={'#000000'} /> },
        { id: 4, name: 'Contact Us', navigation: () => Navigation.navigate('ContactusScreen'), mainicon: <MaterialIcons size={22} name={'quick-contacts-mail'} color={'#000000'} />, icon: <Feather size={25} name={'chevron-right'} color={'#000000'} /> },
        { id: 5, name: 'Feedback', navigation: () => Navigation.navigate('FeedbackScreen'), mainicon: <MaterialIcons size={22} name={'feedback'} color={'#000000'} />, icon: <Feather size={25} name={'chevron-right'} color={'#000000'} /> },
